...
let diseaseData = {
  dGlaucoma: {
    "Disease Report": [{ name: "Glaucoma", percent: 75.8 }],
    "DR Report": [{ name: "dr_0", percent: 100 }],
    "Additional Report": [{ name: "no_dr", percent: 99.3 }],
  },

  dARMD: {
    "Disease Report": [{ name: "ARMD", percent: 73.7 }],
    "DR Report": [{ name: "dr_0", percent: 100 }],
    "Additional Report": [{ name: "no_dr", percent: 99.3 }],
  },

  dDME: {
    "Disease Report": [{ name: "BRVO", percent: 40.3 }],
    "DR Report": [{ name: "dr_2", percent: 100 }],
    "Additional Report": [
  ...
  dDR1: {
    "Disease Report": [{ name: "No Disease", percent: 87.6 }],
    "DR Report": [{ name: "dr_1", percent: 100 }],
    "Additional Report": [{ name: "Micraneurysms", percent: 21.2 }],
  },
  ...
  dDR3: {
    "DR Report": [{ name: "dr_3", percent: 100 }],
    "Additional Report": [
  ...
  dDR4: {
    "Disease Report": [{ name: "Hypertensive DR", percent: 40.9 }],
    "DR Report": [{ name: "dr_4", percent: 100 }],
    "Additional Report": [
  ...
  dDrusen: {
    "Disease Report": [{ name: "Drusen", percent: 59.3 }],
    "DR Report": [{ name: "dr_0", percent: 100 }],
    "Additional Report": [{ name: "no_dr", percent: 93.8 }],
  },
  ...
  dPeripapillaryAtrophy: {
    "Disease Report": [{ name: "Peripapilary Atrophy", percent: 92.5 }],
    "DR Report": [{ name: "dr_0", percent: 100 }],
    "Additional Report": [{ name: "no_dr", percent: 99.8 }],
  },

  dNVD: {
    "Disease Report": [{ name: "Drusen", percent: 51.4 }],
    "DR Report": [{ name: "dr_4", percent: 100 }],
    "Additional Report": [
  ...
  dMyopicDegeneration: {
    "Disease Report": [{ name: "Myopic Degeneration", percent: 94.9 }],
    "DR Report": [{ name: "dr_0", percent: 100 }],
    "Additional Report": [{ name: "no_dr", percent: 98.5 }],
  },
  ...
  dTortousVessels: {
    "Disease Report": [{ name: "Tortuous vessels", percent: 71.7 }],
    "DR Report": [{ name: "dr_0", percent: 100 }],
    "Additional Report": [{ name: "no_dr", percent: 100 }],
  },
  dNormal: {
    "Disease Report": [{ name: "Normal", percent: 93.2 }],
  },
  dDrusenOCT: {
    "Disease Report": [{ name: "Drusen", percent: 92.6 }],
  },
  dDME_OCT: {
    "Disease Report": [{ name: "DME", percent: 93.1 }],
  },
  dCNV: {
    "Disease Report": [{ name: "CNV", percent: 71.2 }],
  },
  dAMD: {
    "Disease Report": [{ name: "AMD", percent: 93.7 }],
  },
  dCSR: {
    "Disease Report": [{ name: "CSR", percent: 91.6 }],
  },
  dDR_OCT: {
    "Disease Report": [{ name: "DR", percent: 84.5 }],
  },
  dMH: {
    "Disease Report": [{ name: "MH", percent: 88.2 }],
  },
};
  ...
  div.addEventListener("click", function () {
    ...
    setTimeout(() => {
      ...
      for (let headline in data) {
        possibleDiseasesDiv.innerHTML += createDiseaseSection(
          headline,
          data[headline]
        );
      }
